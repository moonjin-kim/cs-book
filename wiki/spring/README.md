...
순환 의존성은 A가 B를 필요로 하고 B도 A를 필요로 하는 구조입니다.
...
- pool size가 작고 동시 요청이 많으면 connection pool 고갈이 날 수 있습니다.
...
- scan 범위가 너무 넓으면 의도하지 않은 Bean 등록과 테스트 비용 증가가 생길 수 있습니다.
...
OSIV는 요청이 끝날 때까지 persistence context를 열어두어 Controller/View에서도 lazy loading을 가능하게 합니다.
