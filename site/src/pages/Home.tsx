              ...
              <div className="flex flex-wrap gap-1.5">
                {domain.repos.map((repo) => (
                  <a
                    ...
                    className="inline-flex items-center gap-1 px-2 py-1 rounded text-[11px] font-mono bg-[rgba(255,255,255,0.06)] text-text-muted hover:text-accent hover:bg-accent-dim transition-colors"
                  >
